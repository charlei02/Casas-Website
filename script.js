...
fetch('https://casas-webservice.onrender.com/')
    ...
    .then(data => {
        ...
        `; document.getElementById('education2').innerHTML = `
            <p><strong>Degree2:</strong> ${data.Education[0].Degree}</p>
            <p><strong>Institution2:</strong> ${data.Education[0]. Institution}</p>
            <p><strong>Year2:</strong> ${data.Education[0].Year}</p>
        `;
        document.getElementById('education2').innerHTML = `
        <p><strong>Degree:</strong> ${data.Education[0].Degree}</p>
        <p><strong>Institution:</strong> ${data.Education[0]. Institution}</p>
